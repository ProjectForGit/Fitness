...
class EndomorphMonday : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        list.add(
            Exercise("Жим штанги лежа", "4х12",
                R.drawable.jimshtangi
        )
        )
        list.add(
            Exercise("Жим гантелей лежа на наклонной скамье", "3х10",
                R.drawable.jimgantelei
        )
        )
        list.add(
            Exercise("Жим сидя в тренажере на грудь", "3х12",
                R.drawable.zhim_sidya_v_trenazhere
        )
        )
        list.add(
            Exercise("Жим штанги стоя", "4х12",
                R.drawable.zhim_stoya
        )
        )
        list.add(
            Exercise("Французский жим со штангой лежа", "3х12",
                R.drawable.franzyskyi_zhim
        )
        )
        list.add(
            Exercise("Кикбек с гантелями", "3х12",
                R.drawable.kickback
        )
        )
        list.add(
            Exercise("Тяга штанги к подбородку широким хватом", "4х15",
                R.drawable.tyaga_k_podborodku
            )
        )
        list.add(
            Exercise("Махи гантелями в стороны", "3х15",
