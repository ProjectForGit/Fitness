...
class EndomorphMonday : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        list.add(
            Model("Жим гантелей лежа на наклонной скамье", "3х10",
                R.drawable.jimgantelei
        )
        )
        list.add(
            Model("Жим сидя в тренажере на грудь", "3х12",
                R.drawable.zhim_sidya_v_trenazhere
        )
        )
        list.add(
            Model("Жим штанги стоя", "4х12",
                R.drawable.zhim_stoya
        )
        )
        list.add(
            Model("Французский жим со штангой лежа", "3х12",
                R.drawable.franzyskyi_zhim
        )
        )
        list.add(
            Model("Кикбек с гантелями", "3х12",
                R.drawable.kickback
        )
        )
        list.add(
            Model("Тяга штанги к подбородку широким хватом", "4х15",
                R.drawable.tyaga_k_podborodku
            )
        )
        list.add(
            Model("Махи гантелями в стороны", "3х15",
